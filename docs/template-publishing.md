...
- Leave CodeQL on advanced setup. `.github/workflows/codeql.yml` is the tracked configuration and travels with every repository created from this template; enabling GitHub's default setup in the interface disables that workflow.
